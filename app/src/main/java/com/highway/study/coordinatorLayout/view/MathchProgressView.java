package com.highway.study.coordinatorLayout.view;
...
public class MathchProgressView extends View {
    ...
    public MathchProgressView(Context context, AttributeSet attrs) {

        this(context, attrs, 0);
    }


    public MathchProgressView(Context context, AttributeSet attrs, int defStyle) {
        ...
        ringColor = mTypedArray.getColor(R.styleable.RingProgressBar_ringColor, Color.parseColor("#7C859D"));
        ringProgressColor = mTypedArray.getColor(R.styleable.RingProgressBar_ringProgressColor,
                Color.parseColor("#FC5638"));
        textColor = mTypedArray.getColor(R.styleable.RingProgressBar_textColor, Color.parseColor("#FFFFFF"));
        textSize = mTypedArray.getDimension(R.styleable.RingProgressBar_textSize, 12);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawProgress(canvas);
        //绘制点
        drawPoint(canvas, 360 * progress / max - 90);
    ...
    private void drawPoint(Canvas canvas, float angle) {
        ...
        canvas.drawPoint(centre + x, centre + y, paint);
    }


    private Point calPoint(float angle) {
    ...
    private void drawTextContent(Canvas canvas) {
        ...
        //获取文字的宽度 用于绘制文本内容
        float textWidth = paint.measureText(mDrawText);
        //绘制文本 会根据设置的是否显示文本的属性&是否是Stroke的样式进行判断
        canvas.drawText(mDrawText, centre - textWidth / 2, centre + textSize / 2, paint);
    }
